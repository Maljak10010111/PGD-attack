...
def load_pretrained_models(modelname="pretr_L1"):
    ...
    ckpt = torch.load(os.path.join("models","cifar10", "../../checkpoints/pretr_L1.pth").format(modelname), map_location=torch.device('cpu'))
...
def load_preact_resnet():
    ...
    ckpt = torch.load(os.path.join("models","cifar10", "../../checkpoints/cifar10_prn18_fastegl1.ckpt"), map_location=torch.device('cpu'))
