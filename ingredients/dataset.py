...
def get_label_names(dataset):
    if dataset == "cifar10":
        ...
        return ["tench", "goldfish", "great white shark", "tiger shark", "hammerhead shark", "electric ray", "stingray",
...
def get_dataset_loader_cifar10(batch_size: int, n_examples: int):
    ...
    image_datasets = {}
    dataloaders = {}
    image_datasets["train"] = torchvision.datasets.CIFAR10(root='/data/datasets/',
                                                           download=True, transform=transform)
    dataloaders["train"] = torch.utils.data.DataLoader(image_datasets["train"], batch_size=batch_size,
                                                       shuffle=True, num_workers=2)

    image_datasets["val"] = torchvision.datasets.CIFAR10(root='/data/datasets/', train=False,
                                                         download=True, transform=transform)
